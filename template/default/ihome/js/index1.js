...
var Tree = {
    ...
    getMenuTree: function() {
        ...
        Common.Base.loadJson({
            url: 'http://localhost/u342/plugin.php?id=xiaomy_cus_todo&mod=getMenu',
            type: 'post',
            data: {
                uid: this._uid
            }
    ...
    addChildNode: function() {
        ...
        Common.Base.loadJson({
            url: 'http://localhost/u342/plugin.php?id=xiaomy_cus_todo&mod=addItem',
            type: 'POST',
            data: {
                mid: _inThis._mid,
                uid:this._uid,
    ...
    delMenu: function(_node) {
        ...
        Common.Base.loadJsonNoAsync({
            url: 'http://localhost/u342/plugin.php?id=xiaomy_cus_todo&mod=deleteMenu',
            type: 'POST',
            data: {
                uid:this._uid,
                mid: _node.id
    ...
    delItem: function(_node) {
        ...
        Common.Base.loadJsonNoAsync({
            url: 'http://localhost/u342/plugin.php?id=xiaomy_cus_todo&mod=deleteItem',
            type: 'POST',
            data: {
                uid:this._uid,
                itemid: _node.id
    ...
    */
    editNode:function(_node,_newName){
        ...
        if(_node.isParent){
            // 编辑的是父节点
            Common.Base.loadJsonNoAsync({
                url: 'http://localhost/u342/plugin.php?id=xiaomy_cus_todo&mod=setMenu',
                type: 'POST',
                data: {
                    mid: _node.id,
                    name:_newName
        ...
        Common.Base.loadJsonNoAsync({
            url: 'http://localhost/u342/plugin.php?id=xiaomy_cus_todo&mod=setItem',
            type: 'POST',
            data: {
                itemid: _node.id,
                content:_newName
    ...
    */
    addMenu:function(_node){
        ...
        // 新增正式节点
        Common.Base.loadJsonNoAsync({
            url: 'http://localhost/u342/plugin.php?id=xiaomy_cus_todo&mod=addMenu',
            type: 'POST',
            data: _node
        }, function(json) {
            if (json.code == 200) {
    ...
    */
    addNode:function(_node,_targetNode){    
        ...
        if(_targetNode){
            ...
            Common.Base.loadJsonNoAsync({
                url:"http://localhost/u342/plugin.php?id=xiaomy_cus_todo&mod=catalog",
                type:"post",             
                data:{
                    uid:this._uid,
                    mid:_targetNode.id,
    ...
    */
    sortNode:function(_node,_targetNode,_moveType){
    	if(_moveType != "inner"){
    		...
    		var _result = false;
    		Common.Base.loadJsonNoAsync({
    			url:"http://localhost/u342/plugin.php?id=xiaomy_cus_todo&mod=setItemOrders",
    			type:"get",    			
    			data:{
                    uid:this._uid,
    ...
    */
    getChildNodes:function(){
        ...
        // 获取子节点列表
        Common.Base.loadJson({
            url: 'http://localhost/u342/plugin.php?id=xiaomy_cus_todo&mod=getCatyitem',
            type: 'post',
            data: {
                mid: this._mid
            }
